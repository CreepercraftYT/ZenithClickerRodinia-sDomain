...
local d = {
    ...
    { -- Programmer & Pro Gamer
        ...
        desc = [[HAR with TERASPEED active or completed WU eEX/ueEX, eVL, and eAS]],
        quote = [["WAH-BAAM!"]],
        credit = "@TrevorSmithy",
        rank = floorRank(1, 3, 5, 7, 9, 10, 6200),
        type = 'unranked',
    ...
    { -- eGVeIN
        ...
        desc = [[Lowest quests per second without taking damage upon reaching floor 10 WUT "Lift" and "Visible" mods]],
    ...
    { -- rGV(IN)rNH
        ex = true,
        id = 'TGM1',
        name = "The First Grand Master",
        desc = [[HFD with rNH rGV (IN)]],
        quote = [[A novel idea... a challenge for those who want more.]],
        rank = floorRank(1, 3, 5, 7, 9, 10, 2600),
        mod = "ZCRD",
    },
    { -- rGVrINrNH
        ex = true,
        id = 'rGVrINrNH',
        name = "The Absolute Grand Master",
        desc = [[HFD with rNH rGV rIN]],
        quote = [[Those not satisfied with an already serious challenge, shall face the real one.]],
        rank = floorRank(1, 3, 5, 7, 9, 10, 2600),
        mod = "ZCRD",
    },
    { title = "Issued Rodinia's Domain Achievements", mod = "ZCRD" },
    { -- Rodinia_Vanilla
        id = 'Rodinia_Vanilla',
    ...
    { -- Rodinia_hidden
        id = 'Rodinia_hidden',
        name = "No Background? come on",
        desc = [[(not) See Rodinia's face, with (e)T enabled, or Fancy Background disabled]],
        quote = [["What, am I too much for you? *smirk*"]],
        credit = "@Rodinia",
        type = 'issued',
        hide = TRUE,
        mod = "ZCRD",
